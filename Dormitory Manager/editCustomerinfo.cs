...
namespace Dormitory_Manager
{
    public partial class editCustomerinfo : Form
    {
        ...
        public editCustomerinfo(string CusID)
        {
            InitializeComponent();
            cusID = CusID;
            load();
        ...
        private void load()
        {
            DataTable dt = mod.loadCustomerwithID(cusID);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (fname != "" && lname != "" && id != "" && addr != "" && mod.editCustomer(cusID,fname, lname, birth, Sex, id, phone, mail, addr) )
            {
                Close();
            }
